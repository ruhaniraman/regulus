...
# --- Build a reliable path to the model file ---
# This finds the directory where the current script (predict.py) is located
script_dir = os.path.dirname(os.path.abspath(__file__))
# This joins that directory path with the model's filename
model_path = os.path.join(script_dir, 'mining_detector.h5')

# Load the trained model using the correct, full path.
print("Loading trained model...")
MODEL = tf.keras.models.load_model(model_path) # <-- Use the new, full path
